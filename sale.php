...
if(isset($_GET['type'])) {
	...
	$chirie = $conn->query("SELECT * FROM cars WHERE type='$type'");

	$chirie->execute();

	$allListings = $chirie->fetchAll(PDO::FETCH_OBJ);
            ...
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              ...
              <div class="ml-auto d-flex align-items-center">
                <div>
                  ...
                  <a href="rent.php?=Chirie" class="view-list px-3 border-right">Cumpără</a>
                  <a href="#" class="view-list px-3">Închiriază</a>
                </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="car-entry h-100">
              <a href="car-details.php?id=<?php echo $allListing->id; ?>" class="car-thumbnail">
              <div class="offer-type-wrap">

                  <span class="offer-type bg-<?php if ($allListing->type == "Chirie") {echo "success";} else {echo "danger";}?>"><?php echo $allListing->type; ?> </span>
                </div>
                <img src="images/<?php echo $allListing->image; ?>" alt="Image" class="img-fluid">
              </a>
              <div class="p-4 car-body">
                <h2 class="car-title"><a href="car-details.php?id=<?php echo $allListing->id; ?>"><?php echo $allListing->name; ?></a></h2>
                <span class="car-location d-block mb-3"><span class="car-icon icon-room"></span><?php echo $allListing->location; ?></span>
                <strong class="car-price text-primary mb-3 d-block text-success"><?php echo $allListing->price; ?></strong>
                <ul class="car-specs-wrap mb-3 mb-lg-0">
                  <li>
                    <span class="car-specs">Scaune</span>
                    <span class="car-specs-number"><?php echo $allListing->seats; ?></span>
                    
                  </li>

                  <li>
                    <span class="car-specs">KM</span>
                    <span class="car-specs-number"><?php echo $allListing->km; ?></span>
